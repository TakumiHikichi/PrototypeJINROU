 ...
 */
public class MadManAction implements ActionIF {
    private static MadManAction instance;
    private void VillagerSeparate(){}
    public static MadManAction getInstance(){
        if(instance==null)instance=new MadManAction();
        return instance;
    }
