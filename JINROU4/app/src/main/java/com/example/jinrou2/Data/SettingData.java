...
public class SettingData {
    ...
    private static String getDefaultSetting(int memberNum){
        switch(memberNum)
        {
            ...
            case 9:
                return "WOLF,WOLF,WOLF,FORTUNE_TELLER,MAD_MAN,VILLAGER,VILLAGER,VILLAGER,VILLAGER";
            case 10:
                return "WOLF,WOLF,WOLF,FORTUNE_TELLER,MAD_MAN,VILLAGER,VILLAGER,VILLAGER,VILLAGER,VILLAGER";
            case 11:
